...
addLayer("mini", {
        ...
        buyables: {
                ...
                71: {
                        ...
                        cost(){
                                ...
                                if (hasUpgrade("mini", 42)) exp2 = new Decimal(6)
                ...
                73: {
                        ...
                        display(){
                                ...
                                let eformula = "tokens<sup>x</sup><br>" + format(getBuyableBase("mini", 73)) + "^x" //+ getBuyableEffectString(layer, id)
                                //if its undefined set it to that
                                //otherwise use normal formula
                                let ef1 = "<b><h2>Effect formula</h2>:<br>"
                                let ef2 = "</b><br>"
                ...
                82: {
                        ...
                        base(){
                                return tmp.tokens.milestones[23].effect.max(1)
                        },
                        effect(){
                        ...
                        display(){
                                ...
                                let eformula = "<bdi style='color:#CC0033'>C</bdi><sup>x</sup><br>" + format(getBuyableBase("mini", 82)) + "^x" //+ getBuyableEffectString(layer, id)
                                //if its undefined set it to that
                                //otherwise use normal formula
                                let ef1 = "<b><h2>Effect formula</h2>:<br>"
                                let ef2 = "</b><br>"
                ...
                103: {
                        ...
                        display(){
                                ...
                                let eformula = "(Exponential effect)<sup>x</sup><br>" + format(getBuyableBase("mini", 103)) + "^x"
                                //if its undefined set it to that
                                //otherwise use normal formula
                                let ef1 = "<b><h2>Effect formula</h2>:<br>"
                                let ef2 = "</b><br>"
        ...
        upgrades: {
                ...
                41: {
                        ...
                        description(){
                                let a = "C Point gain 7's log10 becomes log2"
                ...
                "C": {
                        content: [
                                ...
                                ["display-text", function(){
                                        ...
                                        let a = "this will be the values and the options for text disp things"
                                        return ret 
                                }],
                        ],
                        unlocked(){
        ...
        upgrades: {
                ...
                81: {
                        ...
                        canAfford(){
                                ...
                                return hasUpgrade("mini", 31) || (!hasUpgrade("tokens", 82))
                        },
                ...
                82: {
                        ...
                        canAfford(){
                                ...
                                return hasUpgrade("mini", 31) || (!hasUpgrade("tokens", 81))
                        },
                        cost:() => new Decimal(2e4),
                        currencyLocation:() => player.tokens.coins,
                        currencyInternalName:() => "points",
                ...
                93: {
                        ...
                        currencyDisplayName:() => "Coins",
                        unlocked(){
                                return player.tokens.total.gte(61)
                ...
                94: {
                        ...
                        currencyDisplayName:() => "Coins",
                        unlocked(){
                                return player.tokens.total.gte(63)
                ...
                95: {
                        ...
                        currencyDisplayName:() => "Coins",
                        unlocked(){
                                return player.tokens.total.gte(64)
